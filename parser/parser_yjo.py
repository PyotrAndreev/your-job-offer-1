...
from data_base.models import Vacancy as DB_Vacancy, engine
from data_base.updating_bd import update_time
...
def get_hh_vacancies(start_date):
    ...
    file = open('../side_files/hh_vacancies_for_DB', 'w', encoding="utf-8")
