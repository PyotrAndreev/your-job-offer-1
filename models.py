...
class Company(Base):
    ...
    def __repr__(self):
        return f"<Company(company_id={self.company_id}, company_title={self.company_title}, phone={self.phone}, email={self.email})>"
...
class Vacancy(Base):
    ...
    def __repr__(self):
        return f"<Vacancy(vacancy_id={self.vacancy_id}, job_title={self.job_title}, salary={self.salary}, company_id={self.company_id})>"
...
class Resume(Base):
    ...
    def __repr__(self):
        return f"<Resume(resume_id={self.resume_id}, title={self.title}, job_title={self.job_title}, user_id={self.user_id})>"
...
class Submission(Base):
    ...
    def __repr__(self):
        return f"<Submission(submission_id={self.submission_id}, resume_id={self.resume_id}, vacancy_id={self.vacancy_id}, status={self.status})>"
